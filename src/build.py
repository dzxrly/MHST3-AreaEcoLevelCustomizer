...
FMM_CONFIG = {
    "name": "Area Eco Level Customizer",
    "description": "A mod for Monster Hunter Stories 3 that allows players to customize the eco level of each area in the game.",
...
def create_release_lua() -> tuple[str, str]:
    ...
    # save lua file
    save_path = os.path.join(LUA_SAVE_DIR, f"area_eco_level_custom.lua")
